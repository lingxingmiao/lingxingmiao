...
- 🔗 **[TranslatorMinecraft](https://github.com/lingxingmiao/Translator-Minecraft)** - 翻译Minecraft各种内容，没有的提交Issues或者联系我｜`Python` `LLM` `Qwen`
  - 🔗 **[TranslatorMinecraftWeb](https://lingxingmiao.github.io/TranslatorMinecraft.html)** - 纯公益翻译网站，可使用翻译、分离、合并功能；| `HTML` `Qwen`
    - 翻译生成模型：[Qwen3.5-9B-GGUF](https://huggingface.co/unsloth/Qwen3.5-9B-GGUF) Q8_0 翻译得分中等偏上(WMT24++ XCOMET-XXL 72.6分)
    - 文本嵌入模型：[Nomic-Embed-Text-V1.5-GGUF](https://huggingface.co/nomic-ai/nomic-embed-text-v1.5-GGUF) Q4_K_M
...
## 📊 GitHub 统计数据
[![GitHub Stats](https://github-readme-stats.vercel.app/api?username=lingxingmiao&show_icons=true&theme=radical)](https://github.com/lingxingmiao)
[![Top Langs](https://github-readme-stats.vercel.app/api/top-langs/?username=lingxingmiao&layout=compact&theme=radical)](https://github.com/lingxingmiao)

---

## ❤ 联系我
- QQ：3254693390
- Discord：[忘了](https://discord.com/users/1158013644936851470)
- 邮箱：3254693390@qq.com
...
- NAND2: Great Wall GW3000 512GB
- NAND3: SAMSUNG MZVLV128HCGR-000L2 128GB
- NAND4: PHILIPS FM60SS012S/93 SATA 128GB
- NAND5: tigo SSD 120GB
- NAND6: SOYO SSD HB120G
- Display1: AOC2410 24G10ZNE 1080P 240Hz
